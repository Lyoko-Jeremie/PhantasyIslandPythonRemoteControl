-module(ph0apy).
-export([init/0, sleep/1, add_uav/1, land/1, takeoff/2, up/2, down/2, forward/2, back/2, left/2, right/2, goto/4, flip/2, rotate/2, cw/2, ccw/2, speed/2, high/2, led/4, bln/4, rainbow/4, mode/2, stop/1, hover/1]).
